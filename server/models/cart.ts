...
const data = {
    items: {} as Record<number, CartItem[]>, // Record is used to create an object with numeric keys (userId) and values that are arrays of CartItems
}
...
export function update(
    ...
    data.items[userId] = data.items[userId] || [] // Change OR to ?
